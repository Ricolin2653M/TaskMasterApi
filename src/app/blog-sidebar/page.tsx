                      ...
                      <tbody>
                        <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                          <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <code className="text-green-500">200, 201</code>
                          </th>
                        ...
                        <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                          <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <code className="text-amber-500">401</code>
                          </th>
                          <td className="px-6 py-4">
                            Unauthorized	
                          </td>
                        ...
                        <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                          <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <code className="text-amber-500">404</code>
                          </th>
                          <td className="px-6 py-4">
                            Not Found		
                          </td>
                        ...
                        <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                          <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <code className="text-red-500">500, 501, 502, 503, 504</code>
                          </th>
                          <td className="px-6 py-4">
                            Server Errors	
                          </td>
...
{/* aqui inicia uno nuevo */}
  ...
  `}
                  ...
                  <p className="mt-20">The response code : <code className="text-green-500"> 200 </code> is an access and refresh JWT token, like this::</p>
                  <p> &nbsp; </p>
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:px-4 xl:px-5 py-5 ">
                  <code className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight flex justify-center items-center border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  <a
  ...
  {`
    {
      "Token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsImlhdCI6MTY3Mjc2NjAyOCwiZXhwIjoxNjc0NDk0MDI4fQ.
      kCak9sLJr74frSRVQp0_27BY4iBCgQSmoT3vQVWKzJg",
    }
  ...
  `}
                  ...
                  <code className="bg-red-500">Note: The access token is valid for 20 days</code>

                  <p className="mt-20">Response code : <code className="text-amber-300"> 401 </code></p>
                  <p> &nbsp; </p>
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:px-4 xl:px-5 py-5 ">
                  <code className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight flex justify-center items-center border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  <a
  ...
  `}
                  ...
                  <p className="mt-20">The following should be sent in the body:</p>
                  <p> &nbsp; </p>
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:px-4 xl:px-5 py-5 ">
                  <code className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight flex justify-center items-center border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  <a
                    ...
                    "dateStart": "2024-03-24T10:00:00.000Z",
                  ...
                  <p className="mt-20">The response code : <code className="text-green-500"> 200 </code> if is has the token and has the correct format of the task, like this::</p>
                  <p> &nbsp; </p>
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:px-4 xl:px-5 py-5 ">
                  <code className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight flex justify-center items-center border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  <a
  ...
  `}
                  ...
                  <p className="mt-20">The following should be submitted in the body for editing:</p>
                  <p> &nbsp; </p>
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:px-4 xl:px-5 py-5 ">
  ...
  {`
    ...
    {
      "message" : "Error al actualizar tarea por ID: Cast to ObjectId failed for value \"6600ea6c24649ebcc944a52\" (type string) at path 
      \"_id\" for model \"Task\""
    }
  ...
  `}
                  ...
                  <p className="mt-20">The following should be submitted in the body for deleting (You need to be an admin user):</p>
                  <p> &nbsp; </p>
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:px-4 xl:px-5 py-5 ">
                  <code className="mb-8 text-3xl font-bold leading-tight text-white dark:text-whitblcsk sm:text-2xl sm:leading-tight flex justify-center items-center border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  <a
                  ...
                  <p className="mt-20">The response code : <code className="text-green-500"> 200 </code> if is has the token and has the correct id task, like this::</p>
                  <p> &nbsp; </p>
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:px-4 xl:px-5 py-5 ">
                  <code className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight flex justify-center items-center border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  <a
  ...
  {`
    ...
    {
      "message" : "Debes de ser Administrador"
    }

    or

    {
      "message" : "Error al eliminar tarea por ID: Cast to ObjectId failed for value \"6600ea6c24649ebcc944a52\" (type string) at path 
      \"_id\" for model \"Task\""
    }
